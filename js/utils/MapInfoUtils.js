...
const MapInfoUtils = {
    ...
    clickedPointToGeoJson(clickedPoint) {
        ...
        return [
            ...(clickedPoint.features || []), // highlight features
            {
                ...
                style: [{
                    iconUrl: require('../../MapStore2/web/client/components/map/openlayers/img/marker-icon.png'),
    ...
    services: {
        ...
        wmts: require('../../MapStore2/web/client/utils/mapinfo/wmts'),
        vector: require('../../MapStore2/web/client/utils/mapinfo/vector')
    },
    /**
