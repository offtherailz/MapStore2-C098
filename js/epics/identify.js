...
import { SET_CONTROL_PROPERTIES, SET_CONTROL_PROPERTY, TOGGLE_CONTROL } from '@mapstore/actions/controls';
import { closeFeatureGrid, updateFilter, toggleEditMode, CLOSE_FEATURE_GRID } from '@mapstore/actions/featuregrid';
import { QUERY_CREATE } from '@mapstore/actions/wfsquery';
import { CHANGE_MOUSE_POINTER, CLICK_ON_MAP, UNREGISTER_EVENT_LISTENER, CHANGE_MAP_VIEW, MOUSE_MOVE, zoomToPoint, changeMapView,
    registerEventListener, unRegisterEventListener } from '@mapstore/actions/map';
import { browseData } from '@mapstore/actions/layers';
import { closeAnnotations } from '@mapstore/actions/annotations';
...
import { forceUpdateMapLayout } from '@mapstore/actions/maplayout';

import { centerToMarkerSelector, queryableLayersSelector, queryableSelectedLayersSelector, selectedNodesSelector } from '@mapstore/selectors/layers';
import { modeSelector, getAttributeFilters, isFeatureGridOpen } from '@mapstore/selectors/featuregrid';
import { spatialFieldSelector } from '@mapstore/selectors/queryform';
import { mapSelector, projectionDefsSelector, projectionSelector, isMouseMoveIdentifyActiveSelector } from '@mapstore/selectors/map';
import { boundingMapRectSelector } from '@mapstore/selectors/maplayout';
import { centerToVisibleArea, isInsideVisibleArea, isPointInsideExtent, reprojectBbox} from '@mapstore/utils/CoordinatesUtils';
import { floatingIdentifyDelaySelector } from '@mapstore/selectors/localConfig';
...
import { mouseOutSelector } from '@mapstore/selectors/mousePosition';
import {getBbox, getCurrentResolution, parseLayoutValue} from '@mapstore/utils/MapUtils';
...
import {updatePointWithGeometricFilter} from "@mapstore/utils/IdentifyUtils";
...
import {buildIdentifyRequest, filterRequestParams} from '@js/utils/MapInfoUtils';
import {
    ...
    mapTipFormatSelector, mapTipActiveLayerIdSelector, generalInfoFormatSelector,
    requestsSelector,
    isLoadedResponseSelector
} from '@js/selectors/mapInfo';
...
export const purgeMapInfoResultsOnRemoveMapPopupEpic = (action$, {getState}) =>
    action$.ofType(REMOVE_MAP_POPUP)
...
export const setMapTipActveLayerIdEpic = (action$, store) =>
