...
import { closeFeatureGrid, updateFilter, toggleEditMode, CLOSE_FEATURE_GRID } from '../../MapStore2/web/client/actions/featuregrid';
import { QUERY_CREATE } from '../../MapStore2/web/client/actions/wfsquery';
import { CHANGE_MOUSE_POINTER, CLICK_ON_MAP, UNREGISTER_EVENT_LISTENER, CHANGE_MAP_VIEW, MOUSE_MOVE, zoomToPoint, changeMapView,
    registerEventListener, unRegisterEventListener } from '../../MapStore2/web/client/actions/map';
import { browseData } from '../../MapStore2/web/client/actions/layers';
import { closeAnnotations } from '../../MapStore2/web/client/actions/annotations';
import { MAP_CONFIG_LOADED } from '../../MapStore2/web/client/actions/config';
import {addPopup, cleanPopups, removePopup, REMOVE_MAP_POPUP} from '../../MapStore2/web/client/actions/mapPopups';
import { cancelSelectedItem } from '../../MapStore2/web/client/actions/search';
...
import { mapSelector, projectionDefsSelector, projectionSelector, isMouseMoveIdentifyActiveSelector } from '../../MapStore2/web/client/selectors/map';
import { boundingMapRectSelector } from '../../MapStore2/web/client/selectors/maplayout';
import { centerToVisibleArea, isInsideVisibleArea, isPointInsideExtent, reproject, reprojectBbox, calculateCircleCoordinates,
    calculateCircleRadiusFromPixel } from '../../MapStore2/web/client/utils/CoordinatesUtils';
import { floatingIdentifyDelaySelector } from '../../MapStore2/web/client/selectors/localConfig';
import { createControlEnabledSelector, measureSelector } from '../../MapStore2/web/client/selectors/controls';
import { localizedLayerStylesEnvSelector } from '../../MapStore2/web/client/selectors/localizedLayerStyles';

import {getBbox, getCurrentResolution, parseLayoutValue, getHook, GET_COORDINATES_FROM_PIXEL_HOOK, GET_PIXEL_FROM_COORDINATES_HOOK} from '../../MapStore2/web/client/utils/MapUtils';
import MapInfoUtils from '../utils/MapInfoUtils';
import { IDENTIFY_POPUP } from '../../MapStore2/web/client/components/map/popups';
...
import {getFeatureInfo} from '../../MapStore2/web/client/api/identify';
