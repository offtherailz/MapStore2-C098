...
import GeoCodingApi from '@mapstore/api/Nominatim';
...
export const SET_ENABLE_MAP_TIP_FORMAT = 'IDENTIFY:SET_ENABLE_MAP_TIP_FORMAT';
export const SET_MAP_TIP_ACTIVE_LAYER_ID = 'IDENTIFY:SET_MAP_TIP_ACTIVE_LAYER_ID';
export const SET_GFI_TYPE = 'IDENTIFY:SET_GFI_TYPE';
 ...
 */
export function changeMapInfoFormat(gfiType, mimeType) {
    return {
 ...
 */
export function featureInfoClick(point, layer, filterNameList = [], overrideParams = {}, itemId = null, gfiType = 'featureInfo') {
    return {
...
export const setEnableMapTipFormat = (enable) => ({
    type: SET_ENABLE_MAP_TIP_FORMAT,
    enable
});

export const setMapTipActiveLayerId = (layerId) => ({
    type: SET_MAP_TIP_ACTIVE_LAYER_ID,
    layerId
});

export const setGfiType = (gfiType) => ({
    type: SET_GFI_TYPE,
    gfiType
});
