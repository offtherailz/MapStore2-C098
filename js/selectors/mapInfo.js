...
const { mapSelector, isMouseMoveIdentifyActiveSelector: identifyFloatingTool } = require('../../MapStore2/web/client/selectors/map');
const { isPluginInContext } = require('../../MapStore2/web/client/selectors/context');
...
const {pluginsSelectorCreator} = require('../../MapStore2/web/client/selectors/localConfig');
/**
